...
namespace S1ObjectDefinitions.GHZ
{
	class Bridge : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../levels/GHZ/Bridge/Art.nem", CompressionType.Nemesis);
			img = ObjectHelper.MapASMToBmp(artfile, "../levels/GHZ/Bridge/Sprite.map", 0, 2);
		}
